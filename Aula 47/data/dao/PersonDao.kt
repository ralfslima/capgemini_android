...
import com.example.projetosqlitecapgemini.data.entity.PersonWithAddress
...
interface PersonDao {
    ...
    // Listar pessoas e seus respectivos endereços
    @Transaction
    @Query("SELECT * FROM persons")
    fun getPersonsAndAddress(): Flow<List<PersonWithAddress>>

    // Todos os registros
    @Query("SELECT * FROM persons")
    fun select(): Flow<List<Person>>
